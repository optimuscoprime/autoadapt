...
The exact details how how we run FastQC and cutadapt are printed to the console during execution. For further explanation of what each flag means, please see the FastQC and cutadapt documentation.
